...
import com.onecheckoutV1.ejb.exception.InvalidVoidRequestException;
 ...
 */
public class OneCheckoutVoidRequest extends OneCheckoutBaseRules {
    ...
    public OneCheckoutVoidRequest(String mallId) {
