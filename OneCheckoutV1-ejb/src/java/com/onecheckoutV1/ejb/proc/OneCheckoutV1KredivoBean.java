 ...
 */
@Stateless
public class OneCheckoutV1KredivoBean extends OneCheckoutChannelBase implements OneCheckoutV1KredivoBeanLocal{
    ...
    static {
        mIDAcquirerId = configuration.getString("ACQUIRERID.1010.VALUE", "1010").trim();
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ...
        try {
            ...
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doPayment - T0: %d Start", (System.currentTimeMillis() - timeStart));
            ...
            if (request_good) {
                ...
                PaymentChannel pc = queryHelper.getPaymentChannelByChannel(OneCheckoutPaymentChannel.Kredivo);
...
//                                paymentRequest.setAllAdditionData(parameter);
            ...
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doPayment - T2: %d Finish process", (System.currentTimeMillis() - timeStart));
            return trxHelper;
        } catch (Throwable t) {
            t.printStackTrace();
...
//            }
            ...
            stringBuilder.append("PAYMENTTYPE=").append(URLEncoder.encode(paymentRequest.getPaymentTypeKredivo(), strParam[0])).append(strParam[1]);
...
//            return parameter;
    ...
    public OneCheckoutDataHelper doInvokeStatus(OneCheckoutDataHelper trxHelper, PaymentChannel paymentChannel) {
        ...
        try {
            ...
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doInvokeStatus - T0: %d Start process", (System.currentTimeMillis() - startTime));
            ...
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doInvokeStatus - T1: %d querying transaction", (System.currentTimeMillis() - startTime));
            Transactions transactions = queryHelper.getNotifyTransactionBy(invoiceNo, sessionId, paymentChannel);

            if (transactions == null) {
                OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doInvokeStatus : Transaction is null");
            ...
            if (!Words.equalsIgnoreCase(notifyRequestData.getWORDS())) {
                OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doInvokeStatus : WORDS doesn't match !");
                notifyRequestData.setACKNOWLEDGE(OneCheckoutVerifyFormatData.NOTIFYSTATUS_STOP);
                trxHelper.setNotifyRequest(notifyRequestData);
                return trxHelper;
            }

            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doInvokeStatus - T2: %d update transaction", (System.currentTimeMillis() - startTime));
            ...
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doInvokeStatus - T3: %d start Notify to Merchant", (System.currentTimeMillis() - startTime));
            ...
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doInvokeStatus - T4: %d update trx record", (System.currentTimeMillis() - startTime));
            em.merge(transactions);
            notifyRequestData.setACKNOWLEDGE(resp);
            trxHelper.setNotifyRequest(notifyRequestData);
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doInvokeStatus - T5: %d Finish process", (System.currentTimeMillis() - startTime));
    ...
    public OneCheckoutDataHelper doRedirectToMerchant(OneCheckoutDataHelper trxHelper, PaymentChannel paymentChannel) {
        try {
            long startTime = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doRedirectToMerchant - T0: %d Start process", (System.currentTimeMillis() - startTime));
            Merchants m = trxHelper.getMerchant();
...
//            OneCheckoutLogger.log("TRANSACTIOONID =* " + transactions.getTransactionsId());
            ...
            transactions.setRedirectDatetime(new Date());
            em.merge(transactions);
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doRedirectToMerchant - T1: %d Finish process", (System.currentTimeMillis() - startTime));
            return trxHelper;
        } catch (Throwable th) {
            th.printStackTrace();
            trxHelper.setMessage(th.getMessage());
    ...
    public OneCheckoutDataHelper doCheckStatus(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        ...
        try {
            long startTime = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doCheckStatus - T0: %d Start", (System.currentTimeMillis() - startTime));
            ...
            if (trans != null) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doCheckStatus - Checking status to CORE", (System.currentTimeMillis() - startTime));
            ...
            trxHelper.setCheckStatusRequest(statusRequest);
            trxHelper.setMessage("VALID");
            OneCheckoutLogger.log("OneCheckoutV1KredivoBean.doCheckStatus - T2: %d Finish", (System.currentTimeMillis() - startTime));
            return trxHelper;
        } catch (Throwable th) {
            th.printStackTrace();
            trxHelper.setMessage(th.getMessage());
