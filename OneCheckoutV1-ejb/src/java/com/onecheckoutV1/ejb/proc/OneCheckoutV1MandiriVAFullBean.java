 ...
 */
@Stateless
public class OneCheckoutV1MandiriVAFullBean extends OneCheckoutChannelBase implements OneCheckoutV1MandiriVAFullBeanLocal {
    ...
    public OneCheckoutDataHelper doPayment(OneCheckoutDataHelper trxHelper, PaymentChannel pChannel) {
        ...
        try {
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doPayment - T0: %d Start", (System.currentTimeMillis() - t1));
            ...
            if (request_good) {
                ...
                redirect.setPageTemplate("mandirivafull_input.html");
                ...
                data.put("PAYMENTCHANNEL", OneCheckoutPaymentChannel.MandiriVAFull.value());
...
//                String ocoId = this.generateOcoId(paymentChannelId);
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doPayment - T2: %d Finish", (System.currentTimeMillis() - t1));
    ...
    public OneCheckoutDataHelper doInvokeStatus(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        ...
        try {
            ...
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus - T0: %d Start process", (System.currentTimeMillis() - t1));

            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus - T1: %d querying transaction", (System.currentTimeMillis() - t1));
...
//            OneCheckoutNotifyStatusRequest notify = new OneCheckoutNotifyStatusRequest();
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus - T2: %d update transaction", (System.currentTimeMillis() - t1));
            ...
            if (trans == null) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus : Transaction is null, so insert new transaction");

                sendEmail(trans);

                OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus - %s", trans.getDokuResultMessage());

                OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus - T3: %d start Notify to Merchant", (System.currentTimeMillis() - t1));
                ...
                OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus : statusNotify : %s", resp);

                OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus - T4: %d create trx record", (System.currentTimeMillis() - t1));
            } else {
                ...
                em.merge(trans);
                OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus - T4: %d update trx record", (System.currentTimeMillis() - t1));
            }
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doInvokeStatus - T5: %d Finish process", (System.currentTimeMillis() - t1));
...
//        OneCheckoutNotifyStatusRequest notify = new OneCheckoutNotifyStatusRequest();
        try {
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doCheckStatus - T0: %d Start", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doCheckStatus - T1: %d querying transaction", (System.currentTimeMillis() - t1));
            ...
            trxHelper.setCheckStatusRequest(statusRequest);
            trxHelper.setMessage("VALID");
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doCheckStatus - T2: %d Finish", (System.currentTimeMillis() - t1));
            return trxHelper;
        } catch (Throwable th) {
            th.printStackTrace();
            trxHelper.setMessage(th.getMessage());
            //    notify = super.createEmptyNotify(statusRequest, notify, trxHelper.getPaymentChannel(), OneCheckoutErrorMessage.ERROR_CONNECT_TO_CORE);
    ...
    public OneCheckoutDataHelper doRedirectToMerchant(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        try {
            ...
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doRedirectToMerchant - T0: %d Start process", (System.currentTimeMillis() - t1));
...
//            redirect.setAMOUNT(redirectRequest.getAMOUNT());
            ...
            em.merge(trans);
            OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doRedirectToMerchant - T1: %d Finish process", (System.currentTimeMillis() - t1));
    ...
    public OneCheckoutDataHelper doVoid(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
            ...
            voidRequest.setVOIDRESPONSE("FAILED");
             OneCheckoutLogger.log("OneCheckoutV1MandiriVAFullBean.doVoid : Void is not permitted");
