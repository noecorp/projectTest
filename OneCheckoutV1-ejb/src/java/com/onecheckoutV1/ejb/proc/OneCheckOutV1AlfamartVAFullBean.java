 ...
 */
@Stateless
public class OneCheckOutV1AlfamartVAFullBean extends OneCheckoutChannelBase implements OneCheckOutV1AlfamartVAFullBeanLocal {
...
//                redirect.setPageTemplate("alfamartvalite_input.html");
                redirect.setPageTemplate("alfaMVAResultPaycode.html");
                ...
                data.put("PAYMENTCHANNEL", OneCheckoutPaymentChannel.AlfaMVA.value());
