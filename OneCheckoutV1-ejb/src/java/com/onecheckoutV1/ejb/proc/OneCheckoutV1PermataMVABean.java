 ...
 */
@Stateless
public class OneCheckoutV1PermataMVABean extends OneCheckoutChannelBase implements OneCheckoutV1PermataMVABeanLocal {
    ...
    public OneCheckoutDataHelper doPayment(OneCheckoutDataHelper trxHelper, PaymentChannel pChannel) {
        ...
        try {
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataMVABean.doPayment - T0: %d Start", (System.currentTimeMillis() - t1));
...
//                redirect.setPageTemplate("alfamartvalite_input.html");
                redirect.setPageTemplate("permataMVAResultPaycode.html");
                ...
                data.put("PAYMENTCHANNEL", OneCheckoutPaymentChannel.PermataMVA.value());
...
//                data.put("UA_LOWERCASE", paymentRequest.getUA_LOWERCASE() != null ? paymentRequest.getUA_LOWERCASE() : "");
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataMVABean.doPayment - T2: %d Finish", (System.currentTimeMillis() - t1));
    ...
    public OneCheckoutDataHelper doVoid(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        ...
        OneCheckoutLogger.log("OneCheckoutV1PermataMVABean.doVoid : Void is not permitted");
    ...
    public OneCheckoutDataHelper doRedirectToMerchant(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        ...
        try {
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1PermataMVABean.doRedirectToMerchant - T0: %d Start process", (System.currentTimeMillis() - t1));
            Merchants m = trxHelper.getMerchant();
            ...
            em.merge(trans);
            OneCheckoutLogger.log("OneCheckoutV1PermataMVABean.doRedirectToMerchant - T1: %d Register DOKUWallet", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataMVABean.doRedirectToMerchant - T1: %d Finish process", (System.currentTimeMillis() - t1));
            return trxHelper;
        } catch (Throwable th) {
            th.printStackTrace();
            trxHelper.setMessage(th.getMessage());
