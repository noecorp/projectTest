 ...
 */
@Stateless
public class OneCheckoutV1MandiriSOALiteBean extends OneCheckoutChannelBase implements OneCheckoutV1MandiriSOALiteBeanLocal {
    ...
    public OneCheckoutDataHelper doPayment(OneCheckoutDataHelper trxHelper, PaymentChannel pChannel) {
        ...
        try {
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doPayment - T0: %d Start", (System.currentTimeMillis() - t1));
            ...
            if (request_good) {
                ...
                /*String responseCode = registerVa(trxHelper);
                if(responseCode != null)
                trxHelper.setSystemMessage(responseCode);*/
                ...
                redirect.setPageTemplate("mandirisoalite_input.html");
                ...
                data.put("PAYMENTCHANNEL", OneCheckoutPaymentChannel.MandiriSOALite.value());
...
//                String ocoId = this.generateOcoId(paymentChannelId);
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doPayment - T2: %d Finish", (System.currentTimeMillis() - t1));
    ...
    public OneCheckoutDataHelper doInquiryInvoice(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        try {
            ...
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice - T0: %d Start process", (System.currentTimeMillis() - t1));
         ...
         //   Merchants merchant = trxHelper.getMerchant();
            ...
            String payCode = verifyRequest.getCOMPANYCODE() + merchantCode + OneCheckoutVerifyFormatData.traceNo.format(Integer.parseInt(verifyRequest.getUSERACCOUNT()));
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice - querying transaction");
            ...
            if (merchant.getMerchantReusablePaycode() != null && merchant.getMerchantReusablePaycode() == Boolean.TRUE) {
                ...
                if (transExist.equalsIgnoreCase("2")) {
                    ...
                    OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice - T2: transaction already paid");
                    ...
                    OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice - T2: transaction is not found");
                    ...
                    OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice : Inquiry Successfull : %s");
                }                
            ...
            if (trans == null) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice : Transaction is null");
            ...
            if (!word.equalsIgnoreCase(verifyRequest.getWORDS())) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice : WORDS doesn't match !");
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice - T2: update transaction");
            String ack = createInquiryResponseXML(verifyRequest, trans, basket);

            em.merge(trans);

            //OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice - Notify XML : " + ack);

            verifyRequest.setACKNOWLEDGE(ack);

            trxHelper.setVerifyRequest(verifyRequest);

            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInquiryInvoice - T3: %d Finish process", (System.currentTimeMillis() - t1));
    ...
    public OneCheckoutDataHelper doInvokeStatus(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        ...
        try {
            ...
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInvokeStatus - T0: %d Start process", (System.currentTimeMillis() - t1));

            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInvokeStatus - T1: %d querying transaction", (System.currentTimeMillis() - t1));
...
//            OneCheckoutNotifyStatusRequest notify = new OneCheckoutNotifyStatusRequest();
            ...
            if (trans == null) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInvokeStatus : Transaction is null");
            ...
            if (!word.equalsIgnoreCase(notifyRequest.getWORDS())) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInvokeStatus : WORDS doesn't match !");
                notifyRequest.setACKNOWLEDGE(OneCheckoutVerifyFormatData.NOTIFYSTATUS_STOP);
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInvokeStatus - T2: %d update transaction", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInvokeStatus - %s", trans.getDokuHostRefNum());


            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInvokeStatus - T3: %d start Notify to Merchant", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInvokeStatus - T4: %d update trx record", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doInvokeStatus - T5: %d Finish process", (System.currentTimeMillis() - t1));
...
//        OneCheckoutNotifyStatusRequest notify = new OneCheckoutNotifyStatusRequest();
        try {
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doCheckStatus - T0: %d Start", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doCheckStatus - T1: %d querying transaction", (System.currentTimeMillis() - t1));
            ...
            trxHelper.setCheckStatusRequest(statusRequest);
            trxHelper.setMessage("VALID");
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doCheckStatus - T2: %d Finish", (System.currentTimeMillis() - t1));
            return trxHelper;
        } catch (Throwable th) {
            th.printStackTrace();
            trxHelper.setMessage(th.getMessage());
    ...
    public OneCheckoutDataHelper doReconcile(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        ...
        try {
            ...
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReconcile - T0: %d Start process", (System.currentTimeMillis() - t1));

            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReconcile - T1: %d querying transaction", (System.currentTimeMillis() - t1));
...
//            OneCheckoutNotifyStatusRequest notify = new OneCheckoutNotifyStatusRequest();
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReconcile - T2: %d update transaction", (System.currentTimeMillis() - t1));
            ...
            if (trans == null) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReconcile : Transaction is null");

                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReconcile - %s", trans.getDokuResultMessage());

                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReconcile - T3: %d start Notify to Merchant", (System.currentTimeMillis() - t1));
    ...
    //            notifyStatusMerchant( T trans, HashMap<String, String> params,OneCheckoutPaymentChannel pChannel, boolean reversal,OneCheckoutStepNotify step)
                ...
                String resp = super.notifyStatusMerchant(trans, params, channel, ableToReversal, OneCheckoutStepNotify.INVOKE_STATUS);
            //    OneCheckoutNotifyStatusResponse ack = super.notifyMerchant(m.getMerchantRedirectUrl(), params, m.getMerchantConnectionTimeout(), m.getMerchantReadTimeout(), m.getMerchantNotifyTimeout());
                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReconcile : statusNotify : %s", resp);

                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReconcile - T4: %d insert trx record", (System.currentTimeMillis() - t1));
            } else {
                trans.setDokuApprovalCode(notifyRequest.getAPPROVALCODE());
                trans.setDokuIssuerBank(notifyRequest.getBANK());
                trans.setDokuInvokeStatusDatetime(new Date());
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReconcile - T5: %d Finish process", (System.currentTimeMillis() - t1));
    ...
    public OneCheckoutDataHelper doReversal(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        ...
        try {
            ...
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReversal - T0: %d Start process", (System.currentTimeMillis() - t1));

            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReversal - T1: %d querying transaction", (System.currentTimeMillis() - t1));
            ...
            if (trans == null) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReversal : Transaction is null");
                notifyRequest.setACKNOWLEDGE(OneCheckoutVerifyFormatData.NOTIFYSTATUS_STOP);
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReversal - T2: %d update transaction", (System.currentTimeMillis() - t1));
            trans.setDokuApprovalCode(notifyRequest.getAPPROVALCODE());
            trans.setDokuIssuerBank(notifyRequest.getBANK());
            ...
            String paymentDate = OneCheckoutVerifyFormatData.datetimeFormat.format(trans.getDokuInvokeStatusDatetime());
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReversal - %s", trans.getDokuResultMessage());

            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReversal - T3: %d start Notify to Merchant", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReversal - T4: %d update trx record", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1MandiriSOALiteBean.doReversal - T5: %d Finish process", (System.currentTimeMillis() - t1));
    ...
    private String createInquiryResponseXML(OneCheckoutDOKUVerifyData verifyRequest, Transactions trans, String basket) {
        ...
        try {
            ...
            if (trans != null) {
                ...
                sb.append("<amount>").append(URLEncoder.encode(OneCheckoutVerifyFormatData.sdf.format(trans.getIncAmount().doubleValue()), "UTF-8")).append("</amount>");
