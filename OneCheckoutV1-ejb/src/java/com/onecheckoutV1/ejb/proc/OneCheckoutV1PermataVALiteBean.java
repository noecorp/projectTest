 ...
 */
@Stateless
public class OneCheckoutV1PermataVALiteBean extends OneCheckoutChannelBase implements OneCheckoutV1PermataVALiteBeanLocal {
    ...
    public OneCheckoutDataHelper doPayment(OneCheckoutDataHelper trxHelper, PaymentChannel pChannel) {
        ...
        try {
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doPayment - T0: %d Start", (System.currentTimeMillis() - t1));
            ...
            if (request_good) {
                ...
                redirect.setPageTemplate("permatavalite_input.html");
                ...
                OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doPayment EMAIL[" + trans.getIncEmail() + "]");
                data.put("EMAIL", trans.getIncEmail());
                data.put("STATUSCODE", OneCheckoutErrorMessage.NOT_YET_PAID.value());
                data.put("PAYMENTCHANNEL", OneCheckoutPaymentChannel.PermataVALite.value());
...
//                data.put("UA_LOWERCASE", paymentRequest.getUA_LOWERCASE() != null ? paymentRequest.getUA_LOWERCASE() : "");
                ...
                data.put("PAYREASON", paymentRequest.getPAYREASON() != null ? paymentRequest.getPAYREASON() : "");
...
//                String ocoId = this.generateOcoId(paymentChannelId);
                ...
                OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doPayment - createRedirectAndNotifyCaseFail");
                trxHelper = super.createRedirectAndNotifyCaseFail(trxHelper, errormsg, needNotify, trans);                   
            }

            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doPayment - T2: %d Finish", (System.currentTimeMillis() - t1));
    ...
    public OneCheckoutDataHelper doVoid(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
            ...
            voidRequest.setVOIDRESPONSE("FAILED");
             OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doVoid : Void is not permitted");
    ...
    public OneCheckoutDataHelper doInquiryInvoice(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        try {
            ...
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInquiryInvoice - T0: %d Start process", (System.currentTimeMillis() - t1));
            ...
            String payCode = config.getInt("PERMATA.INIT.NUMBER") + verifyRequest.getCOMPANYCODE() + OneCheckoutVerifyFormatData.fourDigitMalldId.format(Integer.parseInt(merchantCode)) + OneCheckoutVerifyFormatData.traceNo.format(Integer.parseInt(verifyRequest.getUSERACCOUNT()));//String payCode = verifyRequest.getPERMATA_VANUMBER();
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInquiryInvoice - querying transaction");
            ...
            if (merchant.getMerchantReusablePaycode() != null && merchant.getMerchantReusablePaycode() == Boolean.TRUE) {
                ...
                trxHelper.setPaymentChannel(OneCheckoutPaymentChannel.PermataVALite);
...
//                OneCheckoutLogger.log("transExist =* " + transExist);
                if (transExist.equals("2")) {

                    OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInquiryInvoice - T2: transaction already paid");
                ...
                } else if (transExist.equals("0")) {

                    OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInquiryInvoice - T2: transaction is not found");
                ...
                else if (transExist.equals("EMPTY")) {
                    trans = null;
                    ...
                    OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInquiryInvoice : Inquiry Successfull : %s");
                }
            ...
            if (trans == null) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInquiryInvoice : Transaction is null");
            ...
            if (!word.equalsIgnoreCase(verifyRequest.getWORDS())) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInquiryInvoice : WORDS doesn't match !");
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInquiryInvoice - T2: update transaction");
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInquiryInvoice - T3: %d Finish process", (System.currentTimeMillis() - t1));
    ...
    public OneCheckoutDataHelper doInvokeStatus(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        ...
        try {
            ...
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInvokeStatus - T0: %d Start process", (System.currentTimeMillis() - t1));

            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInvokeStatus - T1: %d querying transaction", (System.currentTimeMillis() - t1));

            PropertiesConfiguration config = OneCheckoutProperties.getOneCheckoutConfig();

            String payCode = config.getInt("PERMATA.INIT.NUMBER") + notifyRequest.getCOMPANYCODE() + OneCheckoutVerifyFormatData.fourDigitMalldId.format(Integer.parseInt(notifyRequest.getMERCHANTCODE())) + OneCheckoutVerifyFormatData.traceNo.format(Integer.parseInt(notifyRequest.getUSERACCOUNT()));//String payCode = verifyRequest.getPERMATA_VANUMBER();
...
//            OneCheckoutNotifyStatusRequest notify = new OneCheckoutNotifyStatusRequest();
            ...
            if (trans == null) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInvokeStatus : Transaction is null");
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInvokeStatus - T2: %d update transaction", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInvokeStatus - %s", trans.getDokuHostRefNum());


            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInvokeStatus - T3: %d start Notify to Merchant", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInvokeStatus : statusNotify : %s", resp);
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInvokeStatus - T4: %d update trx record", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doInvokeStatus - T5: %d Finish process", (System.currentTimeMillis() - t1));
    ...
    public OneCheckoutDataHelper doRedirectToMerchant(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        try {
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doRedirectToMerchant - T0: %d Start process", (System.currentTimeMillis() - t1));
            Merchants m = trxHelper.getMerchant();
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doRedirectToMerchant - T1: %d Finish process", (System.currentTimeMillis() - t1));
            return trxHelper;
        } catch (Throwable th) {
            th.printStackTrace();
            trxHelper.setMessage(th.getMessage());
...
//        OneCheckoutNotifyStatusRequest notify = new OneCheckoutNotifyStatusRequest();
        try {
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doCheckStatus - T0: %d Start", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doCheckStatus - T1: %d querying transaction", (System.currentTimeMillis() - t1));
            ...
            if (trans != null) {
                ...
                if (!word.equalsIgnoreCase(checkStatusRequest.getWORDS())) {
                    OneCheckoutLogger.log("oco words    [%s]", word);
                    OneCheckoutLogger.log("client words [%s]", checkStatusRequest.getWORDS());
                    // Create Empty Notify
                ...
                String mallId = trans.getMerchantPaymentChannel().getVAInitNumber();
                if (mallId != null && mallId.trim().length() == 5) {
                    mallId = mallId.substring(1, 4);
                }
                ...
                if (inetResp != null && inetResp.getMsgResponse() != null && inetResp.getMsgResponse().trim().length() > 0 && !inetResp.getMsgResponse().trim().equalsIgnoreCase("ERROR")) {
                    ...
                    OneCheckoutLogger.log("CHECK_STATUS-STATUS[" + paymentStatus + "]");//cek disini
                    if (paymentStatus != null && !paymentStatus.trim().equalsIgnoreCase("") && !paymentStatus.trim().equalsIgnoreCase("INVALID_REQUEST")) {
                        if (!paymentStatus.trim().equalsIgnoreCase("TRX_NOT_FOUND")) {
                            OneCheckoutLogger.log("CHECK_STATUS-UPDATE TRANSACTION BASE ON CHECK STATUS...");
            ...
            trxHelper.setCheckStatusRequest(statusRequest);
            trxHelper.setMessage("VALID");
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doCheckStatus - T2: %d Finish", (System.currentTimeMillis() - t1));
            return trxHelper;
        } catch (Throwable th) {
            th.printStackTrace();
            trxHelper.setMessage(th.getMessage());
...
//                String ocoId = this.generateOcoId(paymentChannelId);
    ...
    public VARegistrationResponse registerVa(OneCheckoutDataHelper trxHelper) {
        ...
        //    PropertiesConfiguration config = OneCheckoutProperties.getOneCheckoutConfig();
            ...
            bp.getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, config.getString("onecheckout.wsdlurl", "http://localhost:8080/VA/MerchantVA"));
            OneCheckoutLogger.log("REGISTER VA TO END POINT >>>  " + ((BindingProvider) port).getRequestContext().get(BindingProvider.ENDPOINT_ADDRESS_PROPERTY));
    ...
    public OneCheckoutDataHelper doReversal(OneCheckoutDataHelper trxHelper, PaymentChannel acq) {
        ...
        try {
            ...
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doReversal - T0: %d Start process", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doReversal - T1: %d querying transaction", (System.currentTimeMillis() - t1));
            ...
            if (trans == null) {
                ...
                OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doReversal : Transaction is null");
                notifyRequest.setACKNOWLEDGE(OneCheckoutVerifyFormatData.NOTIFYSTATUS_STOP);
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doReversal - T2: %d update transaction", (System.currentTimeMillis() - t1));
            trans.setDokuApprovalCode(notifyRequest.getAPPROVALCODE());
            trans.setDokuIssuerBank(notifyRequest.getBANK());
            ...
            String paymentDate = OneCheckoutVerifyFormatData.datetimeFormat.format(trans.getDokuInvokeStatusDatetime());
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doReversal - %s", trans.getDokuResultMessage());


            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doReversal - T3: %d start Notify to Merchant", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doReversal : statusNotify : %s", resp);

 
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doReversal - T4: %d update trx record", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1PermataVALiteBean.doReversal - T5: %d Finish process", (System.currentTimeMillis() - t1));
