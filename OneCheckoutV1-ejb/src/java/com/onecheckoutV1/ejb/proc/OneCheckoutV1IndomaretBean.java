 ...
 */
@Stateless
public class OneCheckoutV1IndomaretBean extends OneCheckoutChannelBase implements OneCheckoutV1IndomaretBeanLocal {
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ...
        try {
            ...
            OneCheckoutLogger.log("OneCheckoutV1IndomaretBean.doPayment - T0: %d Start", (System.currentTimeMillis() - t1));
...
//                redirect.setPageTemplate("alfamartvalite_input.html");
                redirect.setPageTemplate("indomaret_input.html");
                ...
                data.put("PAYMENTCHANNEL", OneCheckoutPaymentChannel.Indomaret.value());
...
//                data.put("VAINITNUMBER", mpc.getVAInitNumber() != null ? mpc.getVAInitNumber() : "");
...
//                data.put("UA_LOWERCASE", paymentRequest.getUA_LOWERCASE() != null ? paymentRequest.getUA_LOWERCASE() : "");
            ...
            OneCheckoutLogger.log("OneCheckoutV1IndomaretBean.doPayment - T2: %d Finish", (System.currentTimeMillis() - t1));
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ...
        OneCheckoutLogger.log("OneCheckoutV1IndomaretBean.doVoid : Void is not permitted");
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        try {
            long t1 = System.currentTimeMillis();
            OneCheckoutLogger.log("OneCheckoutV1IndomaretBean.doRedirectToMerchant - T0: %d Start process", (System.currentTimeMillis() - t1));
            Merchants m = trxHelper.getMerchant();
            ...
            em.merge(trans);
            OneCheckoutLogger.log("OneCheckoutV1IndomaretBean.doRedirectToMerchant - T1: %d Register DOKUWallet", (System.currentTimeMillis() - t1));
            ...
            OneCheckoutLogger.log("OneCheckoutV1IndomaretBean.doRedirectToMerchant - T1: %d Finish process", (System.currentTimeMillis() - t1));
            return trxHelper;
        } catch (Throwable th) {
            th.printStackTrace();
            trxHelper.setMessage(th.getMessage());
