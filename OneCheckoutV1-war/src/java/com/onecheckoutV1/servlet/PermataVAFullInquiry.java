 ...
 * @author aditya
 */
public class PermataVAFullInquiry extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "PermataVAInquiry" + "_" + request.getParameter("MALLID") + "_" + request.getParameter("VANUMBER");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("PermataVAInquiry.processRequest Receiving Verify Request from merchantCode=" + request.getParameter("MALLID") + ", VANUMBER=" + request.getParameter("VANUMBER"));


            onecheckout = WebUtils.parseVerifyDOKURequestData(params, request, session, OneCheckoutPaymentChannel.PermataVAFull);


            if (onecheckout.getMessage().equals("VALID")) {

                OneCheckoutLogger.log("PermataVAInquiry.processRequest Parameters Valid");
            ...
            System.out.println("PermataVAInquiry.processRequest ACKNOWLEDGE : "+ack);
            ...
            out.print("STOP");
            OneCheckoutLogger.log("PermataVAInquiry.processRequest ACKNOWLEDGE : STOP");
