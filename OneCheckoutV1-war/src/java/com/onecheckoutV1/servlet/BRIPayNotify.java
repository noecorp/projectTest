...
public class BRIPayNotify extends HttpServlet {
@Override
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "BRIPayNotify" + "_" + request.getParameter("OrderNumber");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("BRIPayNotify.processRequest Receiving Notify Request from SESSIONID=" + request.getParameter("SESSIONID") + ", OrderNumber=" + request.getParameter("OrderNumber"));

            onecheckout = WebUtils.parseNotifyDOKURequestData(params, request, session,  OneCheckoutPaymentChannel.BRIPay);


            if (onecheckout.getMessage().equals("VALID")) {

                OneCheckoutLogger.log("BRIPayNotify.processRequest Parameters Valid");
            ...
            OneCheckoutLogger.log("BRIPayNotify.processRequest ACKNOWLEDGE : %s", ack);
            out.print(ack);

        } catch (Throwable th) {
            out.print("STOP");
            OneCheckoutLogger.log("BRIPayNotify.processRequest ACKNOWLEDGE : STOP");
