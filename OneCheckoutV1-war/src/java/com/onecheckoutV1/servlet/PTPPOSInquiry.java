 ...
 */
public class PTPPOSInquiry extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "PTPOSInquiry" + "_" + request.getParameter("MALLID") + "_" + request.getParameter("VANUMBER");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("PTPOSInquiry.processRequest Receiving Verify Request from merchantCode=" + request.getParameter("MALLID") + ", VANUMBER=" + request.getParameter("VANUMBER"));


            onecheckout = WebUtils.parseVerifyDOKURequestData(params, request, session, OneCheckoutPaymentChannel.PTPOS);


            if (onecheckout.getMessage().equals("VALID")) {

                OneCheckoutLogger.log("PTPOSInquiry.processRequest Parameters Valid");
            ...
            System.out.println("PTPOSInquiry.processRequest ACKNOWLEDGE : "+ack);
            ...
            out.print("STOP");
            OneCheckoutLogger.log("PTPOSInquiry.processRequest ACKNOWLEDGE : STOP");
