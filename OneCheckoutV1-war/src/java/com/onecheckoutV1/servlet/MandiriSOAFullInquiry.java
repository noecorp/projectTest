 ...
 * @author aditya
 */
public class MandiriSOAFullInquiry extends HttpServlet {

    private String STEPParam = "STEP";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "MandiriSOAFullInquiry" + "_" + request.getParameter("USERACCOUNT") + "_" + request.getParameter("COMPANYCODE");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("MandiriSOAFullInquiry.processRequest Receiving Verify Request from User Account =" + request.getParameter("USERACCOUNT") + ", Company Code =" + request.getParameter("COMPANYCODE"));

            onecheckout = WebUtils.parseVerifyDOKURequestData(params, request, session, OneCheckoutPaymentChannel.MandiriSOAFull);

            if (onecheckout.getMessage().equals("VALID")) {

                OneCheckoutLogger.log("MandiriSOAFullInquiry.processRequest Parameters Valid");
            ...
            OneCheckoutLogger.log("MandiriSOAFullInquiry.processRequest ACKNOWLEDGE : %s",ack);

            out.print(ack);

        } catch (Throwable th) {
            out.print("STOP");
            OneCheckoutLogger.log("MandiriSOAFullInquiry.processRequest ACKNOWLEDGE : STOP");
