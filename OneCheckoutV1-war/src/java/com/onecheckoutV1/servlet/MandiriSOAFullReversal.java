 ...
 * @author aditya
 */
public class MandiriSOAFullReversal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "MandiriSOAFullReversal" + "_" + request.getParameter("TRANSACTIONID")+ "_" + request.getParameter("USERACCOUNT");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("MandiriSOAFullReversal.processRequest Receiving Reversal Request from COMPANYCODE=" + request.getParameter("COMPANYCODE") + ", MERCHANTCODE=" + request.getParameter("MERCHANTCODE") + ", USERACCOUNT=" + request.getParameter("USERACCOUNT"));

            onecheckout = WebUtils.parseReversalDOKURequestData(params, request, session, OneCheckoutPaymentChannel.MandiriSOAFull);

            if (onecheckout.getMessage().equals("VALID")) {

                OneCheckoutLogger.log("MandiriSOAFullReversal.processRequest Parameters Valid");
            ...
            //OneCheckoutLogger.log("MandiriSOAFullReversal.processRequest ACKNOWLEDGE : %s", ack);
            System.out.println("MandiriSOAFullReversal.processRequest ACKNOWLEDGE : ");
            out.print(ack);

        } catch (Throwable th) {
            out.print("STOP");
            OneCheckoutLogger.log("MandiriSOAFullReversal.processRequest ACKNOWLEDGE : STOP");
