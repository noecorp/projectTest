 ...
 * @author aditya
 */
public class CCReversal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            logCode = "CCReversal" + "_" + request.getParameter("OrderNumber");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("CCReversal.processRequest Receiving Notify Request from SESSIONID=" + request.getParameter("SESSIONID") + ", OrderNumber=" + request.getParameter("OrderNumber"));
            ...
            if (onecheckout.getMessage().equals("VALID")) {
                ...
                OneCheckoutLogger.log("CCReversal.processRequest Parameters Valid");
            ...
            OneCheckoutLogger.log("CCReversal.processRequest ACKNOWLEDGE : %s",ack);
            out.print(ack);

        } catch (Throwable th) {
            out.print("STOP");
            OneCheckoutLogger.log("CCReversal.processRequest ACKNOWLEDGE : STOP");
