 ...
 */
public class KlikBCAInquiry extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "KlikBCAInquiry" + "_" + request.getParameter("merchantCode") + "_" + request.getParameter("userId");
            WebUtils.setSecurityAssociation(logCode);                
            OneCheckoutLogger.log("KlikBCAInquiry.processRequest Receiving Verify Request from merchantCode=" + request.getParameter("merchantCode") + ", userId=" + request.getParameter("userId"));            
        
            
            String userIdBCA = request.getParameter("userId");
            
            if (userIdBCA!=null && userIdBCA.equalsIgnoreCase("USRMTR0101")) {
                
                String resp = emptyInquiryData(userIdBCA);
                OneCheckoutLogger.log("KlikBCAInquiry.processRequest ACKNOWLEDGE : %s",resp);
