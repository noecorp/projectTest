 ...
 * @author Opiks
 */
public class DoTokenUpdateCard extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (requestHelper != null && requestHelper.getMerchantActivity() != null && requestHelper.getMerchantActivity().getMerchantIdx() != null) {
                ...
                if (requestHelper.getMerchantActivity().getActivityId() != null && (requestHelper.getMerchantActivity().getActivityId().getId() == EActivity.DO_TOKEN_PAYMENT_DATA.code() || requestHelper.getMerchantActivity().getActivityId().getId() == EActivity.DO_TOKEN_DELETE_CARD.code())) {
                    ...
                    MerchantActivity merchantActivity = manageLocal.startMerchantActivity(requestHelper, requestHelper.getMerchantActivity().getMerchantIdx(), EActivity.DO_TOKEN_UPDATE_CARD, data);
    ...
    throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        System.out.println("---------------------------------------------------------------------------------------");
        System.out.println("                         . : : DO TOKEN UPDATE CARD : : .");
        System.out.println("---------------------------------------------------------------------------------------");
