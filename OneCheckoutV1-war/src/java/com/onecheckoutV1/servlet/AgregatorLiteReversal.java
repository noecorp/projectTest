 ...
 * @author aditya
 */
public class AgregatorLiteReversal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "AgregatorLiteReversal" + "_" + request.getParameter("VAID");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("AgregatorLiteReversal.processRequest Receiving Reversal Request from VAID = " + request.getParameter("VAID") + ", USERACCOUNT=" + request.getParameter("USERACCOUNT"));
            ...
            onecheckout = WebUtils.parseReversalDOKURequestData(params, request, session, channel);
            ...
            if (onecheckout.getMessage().equals("VALID")) {
                ...
                OneCheckoutLogger.log("AgregatorLiteReversal.processRequest Parameters Valid");
            ...
            OneCheckoutLogger.log("AgregatorLiteReversal.processRequest ACKNOWLEDGE : %s", ack);
            out.print(ack);

        } catch (Throwable th) {
            out.print("STOP");
            OneCheckoutLogger.log("AgregatorLiteReversal.processRequest ACKNOWLEDGE : STOP");
