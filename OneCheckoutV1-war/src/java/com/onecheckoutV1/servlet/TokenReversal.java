 ...
 * @author aditya
 */
public class TokenReversal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            logCode = "TokenReversal" + "_" + request.getParameter("OrderNumber");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("TokenReversal.processRequest Receiving Notify Request from SESSIONID=" + request.getParameter("SESSIONID") + ", OrderNumber=" + request.getParameter("OrderNumber"));
            ...
            if (onecheckout.getMessage().equals("VALID")) {
                ...
                OneCheckoutLogger.log("TokenReversal.processRequest Parameters Valid");
            ...
            OneCheckoutLogger.log("TokenReversal.processRequest ACKNOWLEDGE : %s",ack);
            out.print(ack);

        } catch (Throwable th) {
            out.print("STOP");
            OneCheckoutLogger.log("TokenReversal.processRequest ACKNOWLEDGE : STOP");
