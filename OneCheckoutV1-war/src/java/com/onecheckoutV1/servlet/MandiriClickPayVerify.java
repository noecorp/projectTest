 ...
 * @author aditya
 */
public class MandiriClickPayVerify extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "MandiriClickPayVerify" + "_" + request.getParameter("TRANSIDMERCHANT");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("MandiriClickPayVerify.processRequest Receiving Verify Request from SESSIONID=" + request.getParameter("SESSIONID") + ", TRANSIDMERCHANT=" + request.getParameter("TRANSIDMERCHANT"));


            onecheckout = WebUtils.parseVerifyDOKURequestData(params, request, session, OneCheckoutPaymentChannel.DirectDebitMandiri);


            if (onecheckout.getMessage().equals("VALID")) {

                OneCheckoutLogger.log("MandiriClickPayVerify.processRequest Parameters Valid");
            ...
            out.print(ack);
            OneCheckoutLogger.log("MandiriClickPayVerify.processRequest ACKNOWLEDGE : %s",ack);

        } catch (Throwable th) {
            out.print("STOP");
            OneCheckoutLogger.log("MandiriClickPayVerify.processRequest ACKNOWLEDGE : STOP");
