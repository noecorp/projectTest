 ...
 * @author aditya
 */
public class AgregatorLiteInquiry extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "AgregatorLiteInquiry" + "_" + request.getParameter("COMPANYCODE") + "_" + request.getParameter("MERCHANTCODE");
            WebUtils.setSecurityAssociation(logCode);
            OneCheckoutLogger.log("AgregatorLiteInquiry.processRequest Receiving Verify Request from COMPANYCODE=" + request.getParameter("COMPANYCODE") + ", MERCHANTCODE=" + request.getParameter("MERCHANTCODE"));
            ...
            if (onecheckout.getMessage().equals("VALID")) {
                ...
                OneCheckoutLogger.log("AgregatorLiteInquiry.processRequest Parameters Valid");
            ...
            //OneCheckoutLogger.log("AgregatorLiteInquiry.processRequest ACKNOWLEDGE : %s",ack);

            out.print(ack);

            System.out.println("AgregatorLiteInquiry.processRequest ACKNOWLEDGE : "+ack);

        } catch (Throwable th) {
            out.print("STOP");
            OneCheckoutLogger.log("AgregatorLiteInquiry.processRequest ACKNOWLEDGE : STOP");
