 ...
 */
public class CCVerify extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logCode = "CCVerify" + "_" + request.getParameter("TRANSIDMERCHANT");
            WebUtils.setSecurityAssociation(logCode);            
            OneCheckoutLogger.log("CCVerify.processRequest Receiving Verify Request from SESSIONID=" + request.getParameter("SESSIONID") + ", TRANSIDMERCHANT=" + request.getParameter("TRANSIDMERCHANT"));            
            ...
            if (onecheckout.getMessage().equals("VALID")) {   
                ...
                OneCheckoutLogger.log("CCVerify.processRequest Parameters Valid");
            ...
            OneCheckoutLogger.log("CCVerify.processRequest ACKNOWLEDGE : %s", ack);
            out.print(ack);
           
        } catch (Throwable th) { 
            out.print("STOP");
            OneCheckoutLogger.log("CCVerify.processRequest ACKNOWLEDGE : STOP");
