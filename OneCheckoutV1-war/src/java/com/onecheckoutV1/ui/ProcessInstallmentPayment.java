...
public class ProcessInstallmentPayment extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException,TemplateException{
        ...
        try {
            ...
            String paramFlag = request.getParameter(FLAGINSTALLMENTParam);
            ...
            onecheckout = WebUtils.prosesInstallmentData(onecheckout, params, paramFlag);
            ...
            logCode = "OffUsInstallment_" + onecheckout.getMallId() + "_" + onecheckout.getPaymentRequest().getTRANSIDMERCHANT();
    ...
    private void error(OneCheckoutDataHelper onecheckout, HttpServletRequest request, PrintWriter pw) {
        ...
        try {
            OneCheckoutLogger.log("ProcessInstallmentPayment.processRequest Not Verify OK");
            ...
            if (addTrxOnDB) {
                OneCheckoutLogger.log("ProcessInstallmentPayment Successful insert Trx into database");
            }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(Receive.class.getName()).log(Level.SEVERE, null, te);
        }
    }
}