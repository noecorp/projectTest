 ...
 */
public class Process3DSPayment extends HttpServlet {
        ...
        try {
            ...
            try {
                if (onecheckout != null) {
                    ...
                    OneCheckoutLogger.log("XXXXXX ProcessPaymentCIP.processRequest - Customer Refresh on LoadingPage THREE D SECURE...");
                }
            } catch (Throwable th) {
                th.printStackTrace();
            }
